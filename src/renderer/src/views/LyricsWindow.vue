...
<template>
  ...
  >
    <div v-if="isLocked" class="locked-state" @mouseenter="isMouseOver = true" @mouseleave="isMouseOver = false">
      ...
      <div class="lyrics-container locked">
        <div class="lyrics-display">
          <div v-if="!hasSong" class="lyric-empty-message">
            播放队列暂无歌曲~
          </div>
          <template v-else>
            <div
            ...
            <div v-if="!visibleLyrics.current && !visibleLyrics.next" class="lyric-song-info">
              {{ currentSongInfo }}
            </div>
          </template>
        </div>
