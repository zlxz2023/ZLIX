...
const getCurrentResult = (): any[] | undefined => {
    switch (activeTab.value) {
        ...
        case 'album':
            return searchResults.value.albums
        case 'artist':
            return searchResults.value.artists
        case 'playlist':
            return searchResults.value.playlists
        case 'mv':
            return searchResults.value.mvs
        default:
            return undefined
    }
}
...
<template>
    <div class="search-page p-8">
                        ...
                        <td class="track-name">
                            ...
                            <div class="track-info">
                                ...
                                <span class="track-artists">{{
                                    truncateArtistName(song.ar.map((a) => a.name).join(' / '))
                                }}</span>
                            </div>
                        </td>
        ...
        >
            ...
            >
                <div
                    class="w-24 h-24 rounded-full overflow-hidden mb-2 duration-200 active:scale-95 hover:scale-105"
                >
                    <img
        ...
        >
            ...
            >
                <div class="mv-cover-wrapper">
                    <img :src="processImageUrl(mv.cover, 300)" :alt="mv.name" class="mv-cover" />
                ...
                <p class="text-muted text-xs">
                    {{ mv.artistName }} · {{ formatDuration(mv.duration || 0) }}
                </p>
            </div>
        </div>
