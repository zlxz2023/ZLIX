...
<template>
    ...
    >
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-muted select-none"
                    >🔍</span
                >
                <input
                    v-model="searchQuery"
        ...
        <div class="flex items-center gap-5 select-none">
            ...
            <button
                ...
                class="w-8 h-8 flex items-center justify-center rounded-full hover:bg-hover transition-all duration-200 hover:scale-110 active:scale-95 cursor-pointer"
                title="设置"
            >
