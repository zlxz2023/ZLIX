            ...
            <div class="flex-1 flex items-center px-4 gap-4">
                ...
                <div class="flex items-center gap-3 flex-shrink-0">
                    ...
                    <button
                        ...
                        title="歌词"
                    >
                        <img :src="getLyricsIcon" class="w-5 h-5" />
                    </button>
                    ...
                    <div class="relative group">
                        ...
                        >
                            <div class="relative w-full h-full flex flex-col items-center py-3">
                                <!-- 音量条背景 -->
                                <div
                                    class="w-2 h-32 bg-active rounded-full relative overflow-hidden"
                                >
                                    <!-- 音量条填充（从底部往上） -->
                                    <div
                                        ...
                                        :style="{
                                            height: `${
                                                playerStore.isMuted ? 0 : playerStore.volume
                                            }%`
                                        }"
                                    ></div>
                                    <!-- 可拖动滑块（覆盖整个音量条区域） -->
                                ...
                                <!-- 音量百分比（在下方） -->
                                <span class="text-xs text-secondary mt-3"
                                    >{{ playerStore.isMuted ? 0 : playerStore.volume }}%</span
                                >
                            </div>
                        </div>
                    </div>
